...
impl Makrov {
    ...
    fn init_values(number_of_chains: u32, starting_node : usize) -> Vec<Vec<f64>> {
        ...
        //let mut ret = Makrov::add_noise(&vec![vec![1.0f64/(number_of_chains as f64); number_of_chains as usize]; number_of_chains as usize], MAX%number_of_chains);
        let ret = vec![vec![1.0f64/number_of_chains as f64; number_of_chains as usize]; number_of_chains as usize];
